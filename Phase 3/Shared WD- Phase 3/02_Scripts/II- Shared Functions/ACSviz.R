...
USER_IPUMS_SAMPLE_ID  <- "us2023b" #B is for the 5-year sample
...
notes_vbox <- grobTree(
  ...
  textGrob(paste0("1. Source: ", gsub("us", "20", USER_IPUMS_SAMPLE_ID), " IPUMS ACS."), 
  ...
  textGrob("3. Interpret: Percentages represent the share of workers using private vehicles.", 
           gp = gpar(fontface = "italic", fontsize = 8, family = "serif"), hjust = 0, x = 0.05, y = 0.45),
  textGrob("4. Private: Includes Cars, Trucks, Vans, or Motorcycles.", 
