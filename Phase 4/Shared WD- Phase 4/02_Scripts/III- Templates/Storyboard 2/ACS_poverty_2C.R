...
if (!file.exists(TARGET_FILE)) {
  ...
  # FIXED: Added the required 'description' argument
...
plot_caption <- paste0(
  ...
  "Income uses the native Census Household Income (HHINCOME)."
)
...
p_chart <- plot_economic_skyline(
  ...
  weight_var    = "PERWT", 
  y_axis_label  = "Income-to-Poverty Ratio",
  plot_title    = "ACS_poverty_ratio_bottom_third_skyline",
