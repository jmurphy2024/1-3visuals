...
# Logic:   Internal 20-ventile depth with improved axis aesthetics.
# ==============================================================================
...
# --- 2. DATA PROCESSING ---
# Isolate Bottom Third and calculate internal 20-ventile intensity
